...
The Comparable interface has a compareTo method that allows you to compare objects. 
The compareTo method I created uses a different compareTo method that belongs to LocalDate inside of it.
...
compareTo sorts all Transactions objects so they can be printed in order.
